...
class Order extends Model
{
    ...
    {
        $this->selectAllQuery = "SELECT o.id as id, o.name as name, o.phone as phone, p.title as product_title FROM orders o LEFT JOIN products p ON o.product_id=p.id";
